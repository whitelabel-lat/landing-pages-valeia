    ...
    <>
      ...
      <main className="container mx-auto px-4 py-12 lg:py-20">
        <nav className="mb-12 p-6 bg-white dark:bg-whiteColor-dark rounded-lg shadow-sm">
          <h2 className="text-xl font-bold mb-4 text-blackColor dark:text-blackColor-dark">Contenido</h2>
          <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <li><a href="#introduccion" className="text-primaryColor hover:text-secondaryColor transition-colors">1. Introducción</a></li>
            <li><a href="#definiciones" className="text-primaryColor hover:text-secondaryColor transition-colors">2. Definiciones</a></li>
            <li><a href="#datos" className="text-primaryColor hover:text-secondaryColor transition-colors">3. Propiedad y Custodia</a></li>
            <li><a href="#servicios" className="text-primaryColor hover:text-secondaryColor transition-colors">4. Servicios</a></li>
            <li><a href="#obligaciones" className="text-primaryColor hover:text-secondaryColor transition-colors">5. Obligaciones</a></li>
            <li><a href="#pagos" className="text-primaryColor hover:text-secondaryColor transition-colors">6. Pagos</a></li>
          </ul>
        </nav>

        <div className="space-y-12">
          <section id="introduccion" className="p-8 bg-white dark:bg-whiteColor-dark rounded-lg shadow-sm">
            <h2 className="text-2xl font-bold mb-6 text-blackColor dark:text-blackColor-dark">1. Introducción</h2>
            <p className="text-blackColor dark:text-contentColor-dark leading-relaxed">
          ...
          <section id="definiciones" className="p-8 bg-white dark:bg-whiteColor-dark rounded-lg shadow-sm">
            <h2 className="text-2xl font-bold mb-6 text-blackColor dark:text-blackColor-dark">2. Definiciones</h2>
            <div className="text-blackColor dark:text-contentColor-dark leading-relaxed">
          ...
          <section id="datos" className="p-8 bg-white dark:bg-whiteColor-dark rounded-lg shadow-sm">
            <h2 className="text-2xl font-bold mb-6 text-blackColor dark:text-blackColor-dark">3. Propiedad, Custodia y Privacidad de los Datos</h2>
            <div className="text-blackColor dark:text-contentColor-dark leading-relaxed">
              <ul className="space-y-4">
          ...
          <section id="servicios" className="p-8 bg-white dark:bg-whiteColor-dark rounded-lg shadow-sm">
            <h2 className="text-2xl font-bold mb-6 text-blackColor dark:text-blackColor-dark">4. Servicios</h2>
            <p className="text-blackColor dark:text-contentColor-dark leading-relaxed">
          ...
          <section id="obligaciones" className="p-8 bg-white dark:bg-whiteColor-dark rounded-lg shadow-sm">
            <h2 className="text-2xl font-bold mb-6 text-blackColor dark:text-blackColor-dark">5. Obligaciones del Cliente</h2>
            <ul className="space-y-4">
          ...
          <section id="pagos" className="p-8 bg-white dark:bg-whiteColor-dark rounded-lg shadow-sm">
            <h2 className="text-2xl font-bold mb-6 text-blackColor dark:text-blackColor-dark">6. Pagos</h2>
            <p className="text-blackColor dark:text-contentColor-dark leading-relaxed">
